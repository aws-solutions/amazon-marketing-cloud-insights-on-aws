...
# USAGE:
#   ./run-unit-tests.sh --test-file-name amc_insights_tests/microservices/tenant_provisioning_service/lambdas/test_AMCInstance.py
###############################################################################
...
def apply_handler_env():
    ...
    os.environ[
        'ADD_AMC_INSTANCE_LAMBDA_ROLE_ARN'] = "arn:aws:iam::978365123:role/lambda-us-east-1-978365123-invokeAmcApiRole"
...
def test_handler(mock_get_physical_id, test_yaml):
    ...
    with mock_handler_resource(test_yaml) as kms_key:
        ...
        sys.path.insert(0,
                        "./infrastructure/amc_insights/microservices/tenant_provisioning_service/lambdas/AddAMCInstance/")
