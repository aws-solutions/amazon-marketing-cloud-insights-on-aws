...
# ###############################################################################
# PURPOSE:
#   * Unit test for InvokeWorkflowSM
# USAGE:
#   ./run-unit-tests.sh --test-file-name amc_insights_tests/microservices/workflow_manager_service/lambdas/test_InvokeWorkflowSM.py
import os
import sys
import unittest
...
class TestInvokeWorkflowExecutionSM(unittest.TestCase):
    ...
    def test_handler(self):
        from amc_insights.microservices.workflow_manager_service.lambdas.InvokeWorkflowSM.handler import \
            handler
        ...
        self.mock_stepfunctions_client.start_execution.assert_called()
