...
# USAGE:
#   ./run-unit-tests.sh --test-file-name amc_insights_tests/microservices/workflow_manager_service/lambdas/test_CancelWorkflowExecution.py
###############################################################################
import os
...
def test_handler(lambda_event, lambda_context, _mock_imports):
    ...
    assert event == {
        ...
        'executionRequest': {'workflowExecutionId': '6789'},
