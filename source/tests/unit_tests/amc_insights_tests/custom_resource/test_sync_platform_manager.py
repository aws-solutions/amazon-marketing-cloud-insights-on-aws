...
def _mock_functions(monkeypatch):
    ...
    monkeypatch.setattr(
        "amc_insights.custom_resource.platform_management_service.lambdas.sync_platform_manager.list_files_to_sync",
...
def test_on_create_or_update(lambda_event, __mock_imports, _mock_clients, _mock_functions):
    from amc_insights.custom_resource.platform_management_service.lambdas.sync_platform_manager import on_create_or_update
...
def test_list_files_to_sync(__mock_imports):
    from amc_insights.custom_resource.platform_management_service.lambdas.sync_platform_manager import list_files_to_sync
    path = "amc_insights.custom_resource.platform_management_service.lambdas.sync_platform_manager"
