...
# ###############################################################################
# PURPOSE:
#   * Unit test for Selling Partner Reporting/Lambdas/ScheduleSpReport handler.
# USAGE:
#   ./run-unit-tests.sh --test-file-name reporting_microservices_tests/selling_partner_reporting_tests/lambdas/test_ScheduleSpReport.py
###############################################################################
...
class ScheduleSpReport(unittest.TestCase):
    ...
    def setUp(self, mock_get_service_client):   
        os.environ['INVOKE_SP_REPORT_SM_LAMBDA_ARN'] = "INVOKE_SP_REPORT_SM_LAMBDA_ARN"
    ...
    def test_handler_defaults(self, mock_EventsHelper):
        from reporting_microservices.selling_partner_reporting.reporting_service.lambdas.ScheduleSpReport.handler import handler
