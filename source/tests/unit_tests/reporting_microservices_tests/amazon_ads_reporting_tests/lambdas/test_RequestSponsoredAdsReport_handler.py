...
# ###############################################################################
# PURPOSE:
#   * Unit test for Amazon Ads Reporting/Lambdas/RequestSponsoredAdsV3Report handler.
# USAGE:
#   ./run-unit-tests.sh --test-file-name reporting_microservices_tests/amazon_ads_reporting_tests/lambdas/test_RequestSponsoredAdsReport_handler.py
###############################################################################
...
def test_handler_success(mock_amazon_ads_api_response, mock_amazon_ads_api):
    from reporting_microservices.amazon_ads_reporting.reporting_service.lambdas.RequestSponsoredAdsReport.handler import handler
    ...
    mock_amazon_ads_api_instance.request_sponsored_ads_v3_reporting.return_value = MagicMock(
    ...
    mock_amazon_ads_api_instance.request_sponsored_ads_v3_reporting.assert_called_once()
