...
# USAGE:
#   ./run-unit-tests.sh --test-file-name reporting_microservices_tests/amazon_ads_reporting_tests/lambdas/test_CheckReportStatus_handler.py
###############################################################################
...
def test_handler_success(mock_amazon_ads_api_response, mock_amazon_ads_api):
    from reporting_microservices.amazon_ads_reporting.reporting_service.lambdas.CheckReportStatus.handler import handler
    ...
    mock_amazon_ads_api_instance.report_status.return_value = MagicMock(
    ...
    mock_amazon_ads_api_instance.report_status.assert_called_once()
