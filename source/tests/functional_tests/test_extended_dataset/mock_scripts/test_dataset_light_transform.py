...
class CustomTransform():
    def __init__(self):
        logger.info("S3 Blueprint Light Transform initiated for new dataset")
    ...
    def transform_object(self, resource_prefix, bucket, key, team, dataset):
        ...
        local_path = s3_interface.download_object(bucket, key, tmpdir)
        ...
        # ['pre-stage/adtech/testdataset/memberships_parsed.json']
        #######################################################
