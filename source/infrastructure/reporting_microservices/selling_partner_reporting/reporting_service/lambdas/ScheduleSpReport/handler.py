...
INVOKE_SP_REPORT_SM_LAMBDA_ARN = os.environ['INVOKE_SP_REPORT_SM_LAMBDA_ARN']
...
def handler(event, _):
    """
    AWS Lambda function to create a schedule rule for generating an SP report in EventBridge.
    ...
    **Event Requirements**:
    ...
    try:
        ...
        event_helper.create_report_schedule(
            ...
            target_arn=INVOKE_SP_REPORT_SM_LAMBDA_ARN
        )
