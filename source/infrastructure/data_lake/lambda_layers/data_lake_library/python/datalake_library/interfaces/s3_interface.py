...
class S3Interface:
    def __init__(self, log_level=None, s3_client=None, s3_resource=None):
        ...
        self._s3_client = s3_client or get_service_client('s3')
        self._s3_resource = s3_resource or get_service_resource('s3')

    def download_object(self, bucket, key, temp_dir):
        """
        This function is not used by AMC data, but may be useful for the transformation of other dataset
        """
    ...
    def upload_object(self, object_path, bucket, key, kms_key=None):
        ...
        try:
            ...
            if kms_key:
                extra_kwargs = {
                    "ServerSideEncryption": "aws:kms",  # NOSONAR
                    "SSEKMSKeyId": kms_key
                }
